...
const FILES: Record<ContentId, string> = {
  ...
  "find-the-smallest-divisor": "binary-search/find-the-smallest-divisor.md",
  "capacity-to-ship-packages-within-d-days": "binary-search/capacity-to-ship-packages-within-d-days.md",
  "kth-missing-positive-number": "binary-search/kth-missing-positive-number.md",
  "painters-partition": "binary-search/painters-partition.md",
  "kth-element-of-2-sorted-arrays": "binary-search/kth-element-of-2-sorted-arrays.md",
  "find-peak-element-ii": "binary-search/find-peak-element-ii.md",
  "aggressive-cows": "binary-search/aggressive-cows.md",
  "book-allocation-problem": "binary-search/book-allocation-problem.md",
  "split-array-largest-sum": "binary-search/split-array-largest-sum.md",
  "minimize-max-distance-to-gas-station": "binary-search/minimize-max-distance-to-gas-station.md",
  "median-of-2-sorted-arrays": "binary-search/median-of-2-sorted-arrays.md",
  "search-in-a-2d-matrix": "binary-search/search-in-a-2d-matrix.md",
  "search-in-2d-matrix-ii": "binary-search/search-in-2d-matrix-ii.md",
  ...
  "length-of-loop-in-ll": "linked-lists/length-of-loop-in-ll.md",
  "check-if-ll-is-palindrome-or-not": "linked-lists/check-if-ll-is-palindrome-or-not.md",
  ...
  "find-the-intersection-point-of-y-ll": "linked-lists/find-the-intersection-point-of-y-ll.md",
  "add-one-to-a-number-represented-by-ll": "linked-lists/add-one-to-a-number-represented-by-ll.md",
  "add-two-numbers-in-linked-list": "linked-lists/add-two-numbers-in-linked-list.md",
  "find-pairs-with-given-sum-in-doubly-linked-list": "linked-lists/find-pairs-with-given-sum-in-doubly-linked-list.md",
  "introduction-to-doubly-ll": "linked-lists/introduction-to-doubly-ll.md",
  "insert-node-before-head-in-doubly-linked-list": "linked-lists/insert-node-before-head-in-doubly-linked-list.md",
  "delete-head-of-doubly-linked-list": "linked-lists/delete-head-of-doubly-linked-list.md",
  "reverse-a-doubly-linked-list": "linked-lists/reverse-a-doubly-linked-list.md",
  "sort-ll": "linked-lists/sort-ll.md",
